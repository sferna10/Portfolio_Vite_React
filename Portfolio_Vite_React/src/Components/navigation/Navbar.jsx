...
const Navbar = () => {
  ...
  return (
    ...
    >
      <div className="w-full flex justify-start items-center font-lobster text-2xl cursor-pointer hover:-translate-y-1 hover:underline transition-all ">Silvia</div>
      {
      !toggle ? (
        <FontAwesomeIcon
          icon={faBars}
